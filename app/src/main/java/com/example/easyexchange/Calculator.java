            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_dash:
                        Intent a = new Intent(Calculator.this,MainActivity.class);
                        startActivity(a);
                        overridePendingTransition(0,0);
                        return true;
                    case R.id.navigation_convert:
                        Intent b = new Intent(Calculator.this, Convert.class);
                        startActivity(b);
                        overridePendingTransition(0,0);
                        return true;
                    ...
                    case R.id.navigation_about:
                        Intent c = new Intent(Calculator.this,Information.class);
                        startActivity(c);
                        overridePendingTransition(0,0);
                        return true;
                }
